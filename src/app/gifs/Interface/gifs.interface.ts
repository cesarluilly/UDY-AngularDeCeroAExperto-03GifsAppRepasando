// To parse this data:
//
//   import { Convert, ISearchGifsResponse } from "./file";
//
//   const iSearchGifsResponse = Convert.toISearchGifsResponse(json);
//
...
export class Convert {
    public static toISearchGifsResponse(json: string): ISearchGifsResponse {
        return cast(JSON.parse(json), r("ISearchGifsResponse"));
    }

    public static iSearchGifsResponseToJson(value: ISearchGifsResponse): string {
        return JSON.stringify(uncast(value, r("ISearchGifsResponse")), null, 2);
    }
}
